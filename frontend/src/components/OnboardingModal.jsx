...
import {
  Modal, Steps, Button, Space, Input, Alert, Typography, message, Switch,
} from 'antd';
import {
    ...
    >
        ...
        <>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <Space.Compact style={{ width: '100%', marginTop: 4 }}>
              ...
              />
              <Button icon={<FolderOpenOutlined />} onClick={() => handleBrowse('conda')}>
                {t('settings.browse')}
              </Button>
            </Space.Compact>
          </div>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <Space.Compact style={{ width: '100%', marginTop: 4 }}>
              ...
              />
              <Button icon={<FolderOpenOutlined />} onClick={() => handleBrowse('mamba')}>
                {t('settings.browse')}
              </Button>
            </Space.Compact>
          </div>
          ...
          <Space>
            <Button onClick={handleTest} loading={testing}>{t('settings.test')}</Button>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 24 }}>
            <Button onClick={() => setStep(0)}>{t('onboarding.back')}</Button>
            <Space>
              <Button onClick={onSkip}>{t('onboarding.skip')}</Button>
      ...
      {step === 2 && (
        <>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 24 }}>
            <Button onClick={() => setStep(1)}>{t('onboarding.back')}</Button>
